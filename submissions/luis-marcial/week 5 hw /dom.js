(function () {
  ...
  function DOMTree(elements){  //constructor
  ...
  DOMTree.prototype = { //prototype
    ...
    empty: function() {//test $d('li').empty()
      //add your code here
    ...
    remove: function() {//test $d('li').remove()
      //add your code here
      this.each(function(elem){
        elem.parentNode.removeChild(elem)//parent remove child element
      })
    },
    ...
    append: function(string) { //test $d('.blue').remove()
      //add your code here
      this.each(function(elem){
        elem.html +=string
      })
    ...
    attr: function (key, value) {//test:$d('li').attr('class')
      this.each(function(elem){
        if(!value){
      //$d('li').getAttribute()
         console.log(elem.getAttribute(key));
    ...
    //test $d('li').on('click', function(){alert('yay!')})
      //add your code here
